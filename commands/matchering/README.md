# 🚀 IaC Templates for matchering

> View deploy stats for matchering in [DeployStack catalog](https://deploystack.io/c/sergree-matchering)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install matchering deploystack/sergree-matchering` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/sergree-matchering) repository.
