# 🚀 IaC Templates for wewe-rss

> View deploy stats for wewe-rss in [DeployStack catalog](https://deploystack.io/c/cooderl-wewe-rss)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install wewe-rss deploystack/cooderl-wewe-rss` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/cooderl-wewe-rss) repository.
