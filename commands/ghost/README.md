# 🚀 IaC Templates for Ghost

> View deploy stats for Ghost in [DeployStack catalog](https://deploystack.io/c/tryghost-ghost)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install ghost deploystack/tryghost-ghost` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/tryghost-ghost) repository.
