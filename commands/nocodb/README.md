# 🚀 IaC Templates for nocodb

> View deploy stats for nocodb in [DeployStack catalog](https://deploystack.io/c/nocodb-nocodb)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install nocodb deploystack/nocodb-nocodb` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/nocodb-nocodb) repository.
