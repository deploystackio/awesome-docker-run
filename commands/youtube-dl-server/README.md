# 🚀 IaC Templates for youtube-dl-server

> View deploy stats for youtube-dl-server in [DeployStack catalog](https://deploystack.io/c/nbr23-youtube-dl-server)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install youtube-dl-server deploystack/nbr23-youtube-dl-server` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/nbr23-youtube-dl-server) repository.
