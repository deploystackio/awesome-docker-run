# 🚀 IaC Templates for chartdb

> View deploy stats for chartdb in [DeployStack catalog](https://deploystack.io/c/chartdb-chartdb)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install chartdb deploystack/chartdb-chartdb` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/chartdb-chartdb) repository.
