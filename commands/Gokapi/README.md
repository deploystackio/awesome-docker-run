# 🚀 IaC Templates for Gokapi

> View deploy stats for Gokapi in [DeployStack catalog](https://deploystack.io/c/forceu-gokapi)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install gokapi deploystack/forceu-gokapi` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/forceu-gokapi) repository.
