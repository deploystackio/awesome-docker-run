...
> View deploy stats for awesome-docker-run in [DeployStack catalog](https://deploystack.io/c/erugooss-erugo)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install awesome-docker-run deploystack/erugooss-erugo` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/erugooss-erugo) repository.
