# 🚀 IaC Templates for gateway

> View deploy stats for gateway in [DeployStack catalog](https://deploystack.io/c/portkey-ai-gateway)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install gateway deploystack/portkey-ai-gateway` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/portkey-ai-gateway) repository.
