# 🚀 IaC Templates for PasswordPusher

> View deploy stats for PasswordPusher in [DeployStack catalog](https://deploystack.io/c/pglombardo-passwordpusher)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install passwordpusher deploystack/pglombardo-passwordpusher` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/pglombardo-passwordpusher) repository.
