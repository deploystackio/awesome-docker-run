# 🚀 IaC Templates for Cockpit

> View deploy stats for Cockpit in [DeployStack catalog](https://deploystack.io/c/cockpit-hq-cockpit)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install cockpit deploystack/cockpit-hq-cockpit` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/cockpit-hq-cockpit) repository.
