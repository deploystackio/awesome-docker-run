# 🚀 IaC Templates for chat2api

> View deploy stats for chat2api in [DeployStack catalog](https://deploystack.io/c/lanqian528-chat2api)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install chat2api deploystack/lanqian528-chat2api` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/lanqian528-chat2api) repository.
