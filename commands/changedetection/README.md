# 🚀 IaC Templates for changedetection.io

> View deploy stats for changedetection.io in [DeployStack catalog](https://deploystack.io/c/dgtlmoon-changedetection-io)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install changedetection.io deploystack/dgtlmoon-changedetection-io` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/dgtlmoon-changedetection-io) repository.
