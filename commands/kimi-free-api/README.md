# 🚀 IaC Templates for kimi-free-api

> View deploy stats for kimi-free-api in [DeployStack catalog](https://deploystack.io/c/llm-red-team-kimi-free-api)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install kimi-free-api deploystack/llm-red-team-kimi-free-api` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/llm-red-team-kimi-free-api) repository.
