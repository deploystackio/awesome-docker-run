# 🚀 IaC Templates for yt-dlp-web-ui

> View deploy stats for yt-dlp-web-ui in [DeployStack catalog](https://deploystack.io/c/marcopiovanello-yt-dlp-web-ui)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install yt-dlp-web-ui deploystack/marcopiovanello-yt-dlp-web-ui` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/marcopiovanello-yt-dlp-web-ui) repository.
