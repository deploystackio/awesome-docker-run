# 🚀 IaC Templates for frankfurter

> View deploy stats for frankfurter in [DeployStack catalog](https://deploystack.io/c/lineofflight-frankfurter)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install frankfurter deploystack/lineofflight-frankfurter` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/lineofflight-frankfurter) repository.
