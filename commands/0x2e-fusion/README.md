# 🚀 IaC Templates for fusion

> View deploy stats for fusion in [DeployStack catalog](https://deploystack.io/c/0x2e-fusion)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install fusion deploystack/0x2e-fusion` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/0x2e-fusion) repository.
