# 🚀 IaC Templates for BookBounty

> View deploy stats for BookBounty in [DeployStack catalog](https://deploystack.io/c/thewicklowwolf-bookbounty)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install bookbounty deploystack/thewicklowwolf-bookbounty` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/thewicklowwolf-bookbounty) repository.
