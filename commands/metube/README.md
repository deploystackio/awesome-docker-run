# 🚀 IaC Templates for metube

> View deploy stats for metube in [DeployStack catalog](https://deploystack.io/c/alexta69-metube)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install metube deploystack/alexta69-metube` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/alexta69-metube) repository.
