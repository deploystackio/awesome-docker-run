# 🚀 IaC Templates for EDA

> View deploy stats for EDA in [DeployStack catalog](https://deploystack.io/c/jortilles-eda)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install eda deploystack/jortilles-eda` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/jortilles-eda) repository.
