...
> View deploy stats for awesome-docker-run in [DeployStack catalog](https://deploystack.io/c/erudika-scoold)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install awesome-docker-run deploystack/erudika-scoold` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/erudika-scoold) repository.
