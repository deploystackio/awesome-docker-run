# 🚀 IaC Templates for NextChat

> View deploy stats for NextChat in [DeployStack catalog](https://deploystack.io/c/chatgptnextweb-nextchat)
...
| Helm | `helm repo add deploystack https://deploystackio.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install nextchat deploystack/chatgptnextweb-nextchat` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/chatgptnextweb-nextchat) repository.
